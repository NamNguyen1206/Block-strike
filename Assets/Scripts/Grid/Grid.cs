...
public class Grid : MonoBehaviour
{
    ...
    private bool CheckIfShapeCanBePlacedOnGrid(Shape currentShape)
    {
        ...
        //All indexes of filled squares in the shape
        ...
        {
            Debug.LogError("Shape total square number is not equal to the filled up squares");
        }
    ...
    private List<int[]> GetAllSquaresCombination(int columns, int rows)
    {
        ...
        while(lastRowIndex + (rows - 1) < 9)
        {
            ...
            if(safeIndex > 100)
            {
                Debug.LogError("Safe index exceeded 100");
                break;
            }
        }
        return squareList;
